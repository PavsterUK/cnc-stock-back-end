...
public class StockItemController {
    ...
    public ResponseEntity<?> createStockItem(@RequestBody StockItemDTO stockItemDTO) {
        StockItem stockItem = stockItemService.toStockItem(stockItemDTO);
        StockItem savedStockItem = stockItemService.save(stockItem);
        return new ResponseEntity<>(stockItemService.toDTO(savedStockItem), HttpStatus.CREATED);
    }
